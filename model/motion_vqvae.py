...
from model.quantize import VectorQuantizer,MCVectorQuantizer,ResidualVectorQuantizer
...
if __name__=="__main__":
    ...
    input=torch.randn(8,64,32,6).to(device)
    output=model(x=input,valid=torch.ones(8,64).to(device))
